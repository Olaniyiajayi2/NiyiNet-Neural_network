...
#this network is tested with the animal dataset

# construct command line argument
ap = argparse.ArgumentParser()
ap.add_argument("-d", "--dataset", required = True, help = "path to input dataset")
ap.add_argument("-m", "--model", required = True, help = "path to save the model in")
...
# load the dataste from disk then scale the raw pixel intensities
# to the range [0, 1]
...
model = NiyiNet.build(width = 32, height = 32, depth = 3, classes = 3)
